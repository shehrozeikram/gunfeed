module ExceptionHandler
  ...
  def render_errors(error_messages, status)
    ...
    render json: { api_status: false, errors: error_messages }, status: status
  end

  def render_attributes_errors(error_messages)
    render json: {api_status: false, attributes_errors: error_messages }, status: :unprocessable_entity
  end
